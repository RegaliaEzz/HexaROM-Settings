...
.method static synthetic access$4902(Lcom/android/settings/wifi/mobileap/WifiApSettings;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
    .param p1, "x1"    # Z
...
.method static synthetic access$5002(Lcom/android/settings/wifi/mobileap/WifiApSettings;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
    .param p1, "x1"    # Landroid/net/wifi/WifiConfiguration;
...
.method static synthetic access$5100(Lcom/android/settings/wifi/mobileap/WifiApSettings;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
    .param p1, "x1"    # I
...
.method static synthetic access$5200(Lcom/android/settings/wifi/mobileap/WifiApSettings;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
...
.method static synthetic access$5202(Lcom/android/settings/wifi/mobileap/WifiApSettings;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$5300(Lcom/android/settings/wifi/mobileap/WifiApSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/wifi/mobileap/WifiApSettings;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4, v7}, Landroid/widget/ListView;->setDescendantFocusability(I)V
    ...
    iget-object v7, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mActivity:Landroid/app/Activity;
    ...
    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->wps_tether_pin:Ljava/lang/String;
    ...
    .line 456
    .local v3, "sActivity":Lcom/android/settings/SettingsActivity;
    invoke-virtual {v3}, Lcom/android/settings/SettingsActivity;->getSwitchBar()Lcom/android/settings/widget/SwitchBar;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mSwitchBar:Lcom/android/settings/widget/SwitchBar;
    ...
    iget-object v7, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mSwitchBar:Lcom/android/settings/widget/SwitchBar;
    ...
    invoke-direct {v4, v3, v7, v8}, Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler;-><init>(Landroid/content/Context;Lcom/android/settings/widget/SwitchBar;Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler$IMobileAPHelpController;)V
    ...
    invoke-virtual {v4, v6, v6, v7, v6}, Landroid/widget/Switch;->setPadding(IIII)V
    ...
    .line 478
    :cond_8
    iget-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mSsidPreference:Lcom/android/settings/wifi/mobileap/WifiApDeviceInfoPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mSsidPreference:Lcom/android/settings/wifi/mobileap/WifiApDeviceInfoPreference;

    .line 481
    :cond_9
    iget-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mPasswordPreference:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mPasswordPreference:Landroid/preference/Preference;
    ...
    invoke-direct {v4, v7}, Lcom/android/settings/wifi/mobileap/WifiApHelpScreenPreference;-><init>(Landroid/content/Context;)V
    ...
    .line 492
    :cond_b
    iget-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mHowTo:Lcom/android/settings/wifi/mobileap/WifiApHowToScreenPreference;

    if-nez v4, :cond_c

    .line 493
    new-instance v4, Lcom/android/settings/wifi/mobileap/WifiApHowToScreenPreference;

    iget-object v7, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mActivity:Landroid/app/Activity;

    invoke-direct {v4, v7}, Lcom/android/settings/wifi/mobileap/WifiApHowToScreenPreference;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mHowTo:Lcom/android/settings/wifi/mobileap/WifiApHowToScreenPreference;
    ...
    invoke-virtual {v4, v6}, Lcom/android/settings/wifi/mobileap/WifiApHowToScreenPreference;->setSelectable(Z)V
    ...
    invoke-virtual {v4, v7, v8}, Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler;->onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler;->showDialog(I)V
    ...
    iput-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    .end local v3    # "sActivity":Lcom/android/settings/SettingsActivity;
    :cond_11
    move v1, v6
    ...
    .line 528
    .restart local v3    # "sActivity":Lcom/android/settings/SettingsActivity;
    :cond_13
    iget-object v4, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-static {v4, v10, v6}, Landroid/widget/Toast;->makeText(Landroid/content/Context;II)Landroid/widget/Toast;
    ...
    invoke-virtual {v4, v5}, Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler;->setSoftapEnabled(Z)Z
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mSwitch:Landroid/widget/Switch;

    invoke-virtual {v4, v6, v5}, Lcom/android/settings/wifi/mobileap/WifiApSwitchEnabler;->onCheckedChanged(Landroid/widget/CompoundButton;Z)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 950
    iget-object v9, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mWpsSwitch:Landroid/view/MenuItem;
    ...
    .line 955
    iget-object v9, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mWpspinap:Landroid/view/MenuItem;
    ...
    .line 957
    iget-object v9, p0, Lcom/android/settings/wifi/mobileap/WifiApSettings;->mWpspinclient:Landroid/view/MenuItem;
    ...
    :goto_5
    invoke-direct {p0, v7}, Lcom/android/settings/wifi/mobileap/WifiApSettings;->updateOptionsMenuIcon(Z)V

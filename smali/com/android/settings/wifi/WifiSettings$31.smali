...
.method constructor <init>(Lcom/android/settings/wifi/WifiSettings;Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;ILandroid/net/wifi/WifiManager$ActionListener;)V
    ...
    iput-object p2, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mBssid:Ljava/lang/String;

    iput-object p3, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mConfig:Landroid/net/wifi/WifiConfiguration;

    iput p4, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mNetworkId:I

    iput-object p5, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mListener:Landroid/net/wifi/WifiManager$ActionListener;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 5952
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings$31;->this$0:Lcom/android/settings/wifi/WifiSettings;
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mBssid:Ljava/lang/String;
    ...
    :cond_0
    :goto_1
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    iget v5, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mNetworkId:I

    iget-object v6, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mListener:Landroid/net/wifi/WifiManager$ActionListener;

    # invokes: Lcom/android/settings/wifi/WifiSettings;->connectNetwork(ILandroid/net/wifi/WifiManager$ActionListener;)V
    invoke-static {v4, v5, v6}, Lcom/android/settings/wifi/WifiSettings;->access$4100(Lcom/android/settings/wifi/WifiSettings;ILandroid/net/wifi/WifiManager$ActionListener;)V
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mBssid:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mBssid:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings$31;->val$mConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-static {v4, v5, v6}, Lcom/android/settings/wifi/WifiSettings;->access$3900(Lcom/android/settings/wifi/WifiSettings;Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager$ActionListener;)V
